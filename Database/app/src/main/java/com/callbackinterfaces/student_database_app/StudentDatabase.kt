...
abstract class StudentDatabase : RoomDatabase() {
    ...
    private class PopulateDBAsyncTask(database: StudentDatabase?) : AsyncTask<Void?, Void?, Void?>() {
        ...
        protected override fun doInBackground(vararg params: Void?): Void? {
            studentDao.insertStudent(Student("Venkat", "0001", "LTTS-Android Studio"))
            studentDao.insertStudent(Student("Ganesh", "0002", "LTTS-Android Studio"))
            studentDao.insertStudent(Student("Venkat123", "0003", "LTTS-Android Studio"))
            studentDao.insertStudent(Student("Sandeep", "0004", "LTTS-Android Studio"))
            studentDao.insertStudent(Student("Venky", "0005", "LTTS-Android Studio"))
            return null
        }
